...
Copy AI and Aircraft folder from Bombable-Carriers-Ships and paste it into your Flightgear installation under fgdata folder. You can add Bombable-Objects to custom folder, and register it in FGFS, but AI must be added into fgdata/AI. AI folder contains AI Scenarios for Bombable-Objects.
